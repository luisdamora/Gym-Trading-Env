...
def charts(df, lines=[]):
    ...
    candlesticks = (
        ...
        .add_yaxis(
            ...
            itemstyle_opts=opts.ItemStyleOpts(
                color="#06AF8F", color0="#FC4242", border_color="#06AF8F", border_color0="#FC4242"
            ),
        )
        .set_series_opts()
        .set_global_opts(
    ...
    for line in lines:
        line_plot = (
            ...
            .add_yaxis(
                ...
                linestyle_opts=opts.LineStyleOpts(**line["line_options"])
                if "line_options" in line.keys()
                else None,
            )
            .set_global_opts(
                xaxis_opts=opts.AxisOpts(
    ...
    grid_chart.add(
        ...
        grid_opts=opts.GridOpts(
            pos_left="10%",
            pos_right="8%",
            pos_top=architecture["candlesticks"]["top_%"],
    ...
    grid_chart.add(
        ...
        grid_opts=opts.GridOpts(
            pos_left="10%",
            pos_right="8%",
            pos_top=architecture["volumes"]["top_%"],
    ...
    grid_chart.add(
        ...
        grid_opts=opts.GridOpts(
            pos_left="10%",
            pos_right="8%",
            pos_top=architecture["portfolios"]["top_%"],
    ...
    grid_chart.add(
        ...
        grid_opts=opts.GridOpts(
            pos_left="10%",
            pos_right="8%",
            pos_top=architecture["positions"]["top_%"],
    ...
    grid_chart.add(
        ...
        grid_opts=opts.GridOpts(
            pos_left="10%",
            pos_right="8%",
            pos_top=architecture["rewards"]["top_%"],
